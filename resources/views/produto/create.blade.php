            ...
            <div class="bg-white p-6 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('produtos.store') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="preco" value="{{ old('preco') }}" step="0.01" min="0" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" required>
