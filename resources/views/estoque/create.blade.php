<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Cadastrar Novo Item no Estoque') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white p-6 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('estoque.store') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="quantidade_minima" value="{{ old('quantidade_minima', config('notificacoes.estoque_limite_padrao')) }}" min="0" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full">
                        <p class="text-xs text-gray-500 mt-1">Quando a quantidade atingir este valor, você receberá e-mail e notificação no sistema.</p>
